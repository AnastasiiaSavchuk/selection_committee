 ...
 * @author A.Savchuk.
 */
public class GetApplicantByIdCommand extends Command {
    private static final long serialVersionUID = 1785415963214785469L;
    private static final Logger logger = Logger.getLogger(GetApplicantByIdCommand.class);

    @Override
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        logger.info("GetApplicantByIdCommand starts");
        ...
        logger.info("GetApplicantByIdCommand finished");
